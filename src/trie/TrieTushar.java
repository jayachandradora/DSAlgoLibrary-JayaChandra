...
public class TrieTushar {
	...
	public static void main(String args[]) {
		...
		TrieTushar trie = new TrieTushar();
		trie.insert("Jaya");
		trie.insert("jayaChandra");
		trie.insert("Ishani");
		trie.insert("Sujata");
		
		System.out.println("find the word " +trie.search("Jaya"));
		System.out.println("not find the word " + trie.search("Mahi"));
	}
}
